...
<div className="text-base font-bold mt-2 pl-14 opacity-80 tracking-widest uppercase">Ghi chú: 📝 {feedbackWord.note || feedbackWord.exampleTrans || "Không có ghi chú"}</div>
            </div>
